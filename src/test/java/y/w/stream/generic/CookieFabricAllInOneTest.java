...
public class CookieFabricAllInOneTest {
    ...
    interface Samples {
        ...
        public class Hal extends AbstractBehavior<Hal.Command> {
            ...
            private Behavior<Hal.Command> onOpenThePodBayDoorsPlease(
                ...
                message.respondTo
                    .tell(StatusReply.error("I'm sorry, Dave. I'm afraid I can't do that."));
                return this;
            }
        }
                ...
                context.askWithStatus(
                    ...
                    (response, throwable) -> {
                        if (response != null) {
                            ...
                            // exception here
                            return new Dave.AdaptedResponse(
    ...
    interface StandaloneAskSample {
        ...
        public class CookieFabric extends AbstractBehavior<CookieFabric.Command> {
            ...
            public static class GiveMeCookies implements CookieFabric.Command {
                ...
                public GiveMeCookies(int count,
                    ActorRef<StatusReply<CookieFabric.Cookies>> replyTo) {
                    this.count = count;
            ...
            private Behavior<CookieFabric.Command> onGiveMeCookies(
                CookieFabric.GiveMeCookies request) {
                if (request.count >= 5) {
                    request.replyTo.tell(StatusReply.error("Too many cookies."));
                } else {
                    request.replyTo
                        .tell(StatusReply.success(new CookieFabric.Cookies(request.count)));
                }
        ...
        static class NotShown {
            ...
            public void askAndPrint(ActorSystem<Void> system, ActorRef<CookieFabric.Command> cookieFabric) {
                ...
                System.out.println("In askAndPrint : " + Thread.currentThread().getName());

                result.whenComplete(
                    (reply, failure) -> {
                        System.out.println("In callBack : " + Thread.currentThread().getName());
                        if (reply != null) {
